...
class Googlemaps {
	...
	var $apiKey				= 'AIzaSyDLo5DHCK4qejCx34GkJvP9Tx9zak1az6s'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	var $center				= "0.5767737229162787, 123.07382303743744";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
