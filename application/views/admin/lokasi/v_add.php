...
echo form_open_multipart('lokasi/add',$atribut);
 ?>
                ...
                <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        <div class="widget widget-table-two">
                            ...
                            <input name="nama_lokasi" type="text" class="form-control" placeholder="Nama Lokasi" value="<?php echo set_value('nama_lokasi'); ?>" required>
                        </div>
                        <div class="form-row mb-4">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input name="longitude" type="text" class="form-control" placeholder="Longitude" value="<?php echo set_value('longtitude'); ?>" required>
                            </div>
                        </div>
                        <div class="custom-file-container" data-upload-id="uploadgambar">
                            <label>Upload (Single File) <a href="javascript:void(0)" class="custom-file-container__image-clear" title="Clear Image">x</a></label>
                            <label class="custom-file-container__custom-file" >
                            <input type="file" name="gambar_lokasi" class="custom-file-container__custom-file__custom-file-input" accept="image/*">
  ...
  <div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <div class="col-sm-12">
            ...
            <input name="nama_lokasi" type="text" class="form-control" placeholder="Nama" value="<?php echo set_value('nama_lokasi'); ?>" required>
        </div>
    	</div>
        ...
        <div class="col-sm-6">
  		...
  		<div class="col-sm-12">
        	...
        	<input type="file" name="gambar_lokasi" class="form-control" required>
        </div>
    	</div>
